		...
		SubShader{
			...
			CGPROGRAM
			   ...
			   // #pragma surface surf Lambert alphatest:_Cutoff
				...
				struct Input {
				 ...
				 void vert(inout appdata_full v)
				 {
					 ...
					 float4 midPoint = float4(0, -1, 0, 1); // w = 1.0, https://forum.unity.com/threads/a-vertex-position-is-a-float4-what-does-the-4th-component-represent.152809/
			 ...
			 // Good for reference: https://gist.github.com/unitycoder/c5847a82343a8e721035
					 ...
					 float3 viewDir = worldSpaceVertex - _ObjectPos;
					 viewDir.y = 0;
